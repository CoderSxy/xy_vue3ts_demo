...
import vertexShader from "../assets/shaders/map_line_vertexShader.glsl";
import fragmentShader from "../assets/shaders/map_line_fragmentShader.glsl";
import { MapStreamStyle, StoreConfig } from "../interface.d.ts";
