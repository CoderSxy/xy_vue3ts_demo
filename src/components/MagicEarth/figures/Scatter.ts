...
import type { Coordinates, ScatterStyle, StoreConfig } from "../interface.d.ts";
import { setTween } from "../utils/tween.ts";
import {
  Group,
  Mesh,
  MeshBasicMaterial,
...
export default class Scatter {
  ...
  create(data: Coordinates) {
    if (data.style) {
      ...
      // this._currentStyle = JSON.parse(JSON.stringify(data.style));
    }
